        ...
        for filter in symbol.filters.into_iter() {
            match filter {
                Filters::TrailingDeltaFilter {
                    ...
                    // TODO
                    assert_eq!(max_trailing_above_delta, 0);
                    assert_eq!(min_trailing_above_delta, 0);
                    assert_eq!(max_trailing_below_delta, 0);
                    assert_eq!(min_trailing_below_delta, 0);
                }
                Filters::PriceFilter {
                    min_price,
                    max_price,
